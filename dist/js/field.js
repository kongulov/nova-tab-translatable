...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-tab-translatable', __webpack_require__(3));
  Vue.component('detail-nova-tab-translatable', __webpack_require__(6));
  Vue.component('form-nova-tab-translatable', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_0_laravel_nova__["FormField"], __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["HandlesValidationErrors"], __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["InteractsWithResourceInformation"]],
    ...
    methods: {
        ...
        checkError: function checkError(lang) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "nova-tab-translatable" } }, [
    _c(
      "div",
      { staticClass: "tab-items px-8" },
      _vm._l(_vm.field.languages, function(lang) {
        return _c(
          "span",
          {
            ...
            class: {
              ...
              "has-error": _vm.checkError(lang)
            },
            on: {
              click: function($event) {
                _vm.selectedLang = lang
              }
            }
          },
          [_vm._v("\n            " + _vm._s(lang) + "\n        ")]
    ...
    _c(
      ...
      _vm._l(_vm.field.fields, function(component, index) {
        return _c(
          "div",
          {
            directives: [
              {
                name: "show",
                rawName: "v-show",
                value: _vm.selectedLang === component.locale,
                expression: "selectedLang === component.locale"
              }
            ],
            staticClass: "tab-content"
          },
          [
            _c(_vm.resolveComponentName(component), {
              key: index,
              tag: "component",
              class: {
                "remove-bottom-border ":
                  (index + 1) % _vm.field.originalFieldsCount !== 0
              },
              attrs: {
